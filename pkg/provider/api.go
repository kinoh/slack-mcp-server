...
func (c *MCPSlackClient) SearchFilesContext(ctx context.Context, query string, params slack.SearchParameters) (*slack.SearchFiles, error) {
	return c.slackClient.SearchFilesContext(ctx, query, params)
}
